...
$c_Lcalculator_Calculator$.prototype.calculator$Calculator$$getReferenceExpr__T__sci_Map__Lcalculator_Expr = (function(name, references) {
...
$c_Lcalculator_Calculator$.prototype.eval__Lcalculator_Expr__sci_Map__D = (function(expr, references) {
  _eval: while (true) {
    ...
    if ($is_Lcalculator_Ref(x1)) {
      ...
      var name = x3.name$2;
      if ((name !== null)) {
        var temp$expr = this.calculator$Calculator$$getReferenceExpr__T__sci_Map__Lcalculator_Expr(name, references);
...
$c_Lcalculator_Polynomial$.prototype.computeSolutions__Lcalculator_Signal__Lcalculator_Signal__Lcalculator_Signal__Lcalculator_Signal__Lcalculator_Signal = (function(a, b, c, delta) {
  ...
  var expr = new $c_sjsr_AnonFunction0().init___sjs_js_Function0((function(b$2) {
    return (function() {
      return (-$uD(b$2.apply__O()))
    })
  })(b));
  var negB = new $c_Lcalculator_Signal().init___F0(expr);
  $m_Lcalculator_Signal$();
  var expr$1 = new $c_sjsr_AnonFunction0().init___sjs_js_Function0((function(a$2) {
    return (function() {
      return (2 * $uD(a$2.apply__O()))
    })
  })(a));
  var twoA = new $c_Lcalculator_Signal().init___F0(expr$1);
  $m_Lcalculator_Signal$();
  ...
  var sqrtDelta = new $c_Lcalculator_Signal().init___F0(expr$2);
  $m_Lcalculator_Signal$();
  var expr$3 = new $c_sjsr_AnonFunction0().init___sjs_js_Function0((function(delta$1$1, negB$1, twoA$1, sqrtDelta$1) {
    return (function() {
      if (($uD(delta$1$1.apply__O()) < 0)) {
        return $as_sci_Set($m_s_Predef$().Set$2.apply__sc_Seq__sc_GenTraversable($m_sci_Nil$()))
      } else {
        var array = [(($uD(negB$1.apply__O()) + $uD(sqrtDelta$1.apply__O())) / $uD(twoA$1.apply__O())), (($uD(negB$1.apply__O()) - $uD(sqrtDelta$1.apply__O())) / $uD(twoA$1.apply__O()))];
...
$c_Lcalculator_TweetLength$.prototype.tweetRemainingCharsCount__Lcalculator_Signal__Lcalculator_Signal = (function(tweetText) {
  var expr = new $c_sjsr_AnonFunction0().init___sjs_js_Function0((function(tweetText$1) {
    return (function() {
      return $as_T(tweetText$1.apply__O())
    })
  })(tweetText));
  var s = new $c_Lcalculator_Var().init___F0(expr);
  var expr$1 = new $c_sjsr_AnonFunction0().init___sjs_js_Function0((function(s$1) {
    return (function() {
      return ((140 - $m_Lcalculator_TweetLength$().calculator$TweetLength$$tweetLength__T__I($as_T(s$1.apply__O()))) | 0)
    })
  })(s));
...
$c_Lcalculator_TweetLength$.prototype.colorForRemainingCharsCount__Lcalculator_Signal__Lcalculator_Signal = (function(remainingCharsCount) {
  var i = $uI(remainingCharsCount.apply__O());
  var x1 = (i >= 0);
  if (x1) {
    if ((i < 15)) {
...
$c_Lcalculator_Calculator$$anonfun$computeValues$1.prototype.apply__T2__T2 = (function(va) {
  var jsx$1 = va.$$und1$f;
  $m_Lcalculator_Signal$();
  var expr = new $c_sjsr_AnonFunction0().init___sjs_js_Function0((function(arg$outer, va$1) {
    return (function() {
      return $m_Lcalculator_Calculator$().eval__Lcalculator_Expr__sci_Map__D($m_Lcalculator_Calculator$().calculator$Calculator$$getReferenceExpr__T__sci_Map__Lcalculator_Expr($as_T(va$1.$$und1$f), arg$outer.namedExpressions$1$f), $as_sci_Map(arg$outer.namedExpressions$1$f.$$minus__O__sc_Map(va$1.$$und1$f)))
    })
  })(this, va));
